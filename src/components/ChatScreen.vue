<template>
  <div class="chat-screen" role="main">
    ...
    <!-- Share widget -->
    <div v-if="showShareWidget" class="share-widget" ref="shareWidget">
...
// Watch for share widget visibility
...
// Watch for new messages to auto-scroll and announce
...
function handleMessagesKeydown(event: KeyboardEvent) {
  ...
  if (event.key === 'ArrowUp' || event.key === 'ArrowDown') {
    event.preventDefault();
    // Focus management for message navigation could be implemented here
  }
}

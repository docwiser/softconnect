<template>
  <div class="call-screen" role="main" :class="{ 'call-incoming': callState.isIncoming }">
    <!-- Incoming call interface -->
    <div v-if="callState.isIncoming" class="incoming-call-container">
      <div class="incoming-call-content">
        ...
        <div class="incoming-call-actions">
          ...
          <button 
            ...
            :aria-expanded="showRejectOptions"
        ...
        <div v-if="showRejectOptions" class="reject-options-widget" ref="rejectOptionsWidget">
    ...
    <div v-else-if="callState.isActive" class="active-call">
      ...
      <!-- Settings widget -->
      <div v-if="showSettings" class="settings-widget" ref="settingsWidget">
        ...
        <div class="settings-group">
          ...
          <select 
            ...
            @change="changeAudioInput($event.target.value)"
        ...
        <div class="settings-group">
          ...
          <select 
            ...
            @change="changeAudioOutput($event.target.value)"
            class="settings-select"
          >
        ...
        <div v-if="callState.isVideoEnabled" class="settings-group">
          ...
          <select 
            ...
            @change="changeVideoInput($event.target.value)"
            class="settings-select"
          >
        ...
        <div class="settings-group">
          ...
          <input 
            ...
            @input="changePlaybackSpeed($event.target.value)"
...
onMounted(async () => {
  ...
  // Focus management for incoming calls
...
// Watch for reject options visibility
...
// Watch for keyboard help visibility
  ...
  if (event.ctrlKey) {
    ...
    switch (event.key.toLowerCase()) {
      case 'm':
        ...
        if (event.shiftKey) {
          // Ctrl+Shift+M: Change microphone
          cycleAudioInput();
        } else {
          // Ctrl+M: Mute/Unmute
          toggleMute();

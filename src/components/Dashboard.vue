<template>
  <div class="dashboard" id="main-content" tabindex="-1">
    ...
    <nav class="sidebar" :class="{ open: sidebarOpen }" aria-label="Main navigation" :aria-hidden="!sidebarOpen && isMobile ? 'true' : undefined">
    ...
    <div class="main-area">
      <header class="topbar" role="banner">
        ...
        <div class="topbar-actions">
          <RouterLink to="/meetings" class="meetings-quick-btn" aria-label="Go to meetings" title="Meetings">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" aria-hidden="true"><path d="M15 10l4.553-2.069A1 1 0 0121 8.87v6.26a1 1 0 01-1.447.894L15 14M3 8a2 2 0 012-2h10a2 2 0 012 2v8a2 2 0 01-2 2H5a2 2 0 01-2-2V8z"/></svg>
          </RouterLink>
          <RouterLink to="/new-chat" class="new-chat-btn" aria-label="Start a new conversation" title="New chat">
...
.topbar { display: flex; align-items: center; gap: 1rem; padding: 1rem 1.5rem; border-bottom: 1px solid rgba(255,255,255,0.06); background: rgba(7,10,20,0.85); backdrop-filter: blur(20px); }
.menu-btn { display: none; background: rgba(255,255,255,0.06); border: 1px solid rgba(255,255,255,0.07); border-radius: 10px; color: rgba(255,255,255,0.7); font-size: 1.25rem; cursor: pointer; padding: 0; width: 40px; height: 40px; align-items: center; justify-content: center; }
.menu-btn:focus-visible { outline: 3px solid #7c6fff; outline-offset: 2px; }
.page-title { flex: 1; font-family: 'Syne', sans-serif; font-size: 1.25rem; font-weight: 700; color: #fff; margin: 0; }
.topbar-actions { display: flex; align-items: center; gap: 0.5rem; }
.meetings-quick-btn { width: 40px; height: 40px; background: rgba(92,59,255,0.12); border-radius: 10px; display: flex; align-items: center; justify-content: center; text-decoration: none; transition: all 0.2s; border: 1px solid rgba(92,59,255,0.2); color: rgba(255,255,255,0.65); }
.meetings-quick-btn:hover { background: rgba(92,59,255,0.25); color: #a78bfa; border-color: rgba(92,59,255,0.4); }
.meetings-quick-btn:focus-visible { outline: 3px solid #7c6fff; outline-offset: 2px; }
.new-chat-btn { width: 40px; height: 40px; background: rgba(92,59,255,0.2); border-radius: 10px; display: flex; align-items: center; justify-content: center; font-size: 1rem; text-decoration: none; transition: all 0.2s; border: 1px solid rgba(92,59,255,0.35); }
.new-chat-btn:hover { background: rgba(92,59,255,0.35); }
.new-chat-btn:focus-visible { outline: 3px solid #a78bfa; outline-offset: 2px; }

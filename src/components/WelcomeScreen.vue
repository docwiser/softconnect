...
<h1 class="welcome-title">Welcome to Soft Connect</h1>
<p class="welcome-subtitle">we re-engineered Soft Connect as an Open-source platform. we do not collect any informations from you. Enter your name to get started</p>
<form @submit.prevent="handleSubmit" class="welcome-form">
<div class="form-group">
<label for="username" class="form-label">Your Name (shown to the other party):</label>
<input 
id="username"
ref="nameInput"
v-model="userName" 
...
errorMessage.value = "";
announcement.value = "Connecting to Soft Connect...";
try {
